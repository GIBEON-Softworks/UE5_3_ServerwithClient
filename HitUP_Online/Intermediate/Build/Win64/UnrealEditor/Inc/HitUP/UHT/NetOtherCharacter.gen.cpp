...
#include "Characters/NetOtherCharacter.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeNetOtherCharacter() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_ACharacter();
	HITUP_API UClass* Z_Construct_UClass_ANetOtherCharacter();
	HITUP_API UClass* Z_Construct_UClass_ANetOtherCharacter_NoRegister();
...
// End Cross Module References
	...
	template<> HITUP_API UClass* StaticClass<ANetOtherCharacter>()
	{
		return ANetOtherCharacter::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ANetOtherCharacter);
	ANetOtherCharacter::~ANetOtherCharacter() {}
	struct Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_Characters_NetOtherCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_Characters_NetOtherCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANetOtherCharacter, ANetOtherCharacter::StaticClass, TEXT("ANetOtherCharacter"), &Z_Registration_Info_UClass_ANetOtherCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANetOtherCharacter), 2035253006U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_Characters_NetOtherCharacter_h_3143070192(TEXT("/Script/HitUP"),
		Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_Characters_NetOtherCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_Characters_NetOtherCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
