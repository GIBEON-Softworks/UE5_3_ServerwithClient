...
#include "CustomActors/NetActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeNetActor() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	HITUP_API UClass* Z_Construct_UClass_ANetActor();
	HITUP_API UClass* Z_Construct_UClass_ANetActor_NoRegister();
...
// End Cross Module References
	...
	template<> HITUP_API UClass* StaticClass<ANetActor>()
	{
		return ANetActor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ANetActor);
	struct Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_CustomActors_NetActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_CustomActors_NetActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANetActor, ANetActor::StaticClass, TEXT("ANetActor"), &Z_Registration_Info_UClass_ANetActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANetActor), 2702209792U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_CustomActors_NetActor_h_1784301991(TEXT("/Script/HitUP"),
		Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_CustomActors_NetActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HitUP_Online_Source_HitUP_Online_CustomActors_NetActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
